    ...
    return (
      <div className='flex min-h-screen items-center justify-center'>
        <div className='text-red-400 text-center'>
          <p className='text-lg font-semibold'>Error al cargar la conversación</p>
    ...
    <div className='flex min-h-screen'>
      ...
      <div className='flex-1 flex flex-col'>
        <div className='flex-1 flex flex-col'>
                ...
                <div className='flex items-end gap-3'>
                  ...
                  <div className='flex flex-1 flex-col gap-1'>
                    ...
                    <div className='text-sm sm:text-base max-w-full sm:max-w-[400px] lg:max-w-[500px] rounded-lg px-3 sm:px-4 py-2 sm:py-3 bg-slate-700 text-white'>
                      <p>¡Hola! Soy TesisAI. Puedo ayudarte a encontrar tesis y pretesis académicas. ¿Qué te gustaría buscar?</p>
                    </div>
                  </div>
                </div>
              )}
          ...
          <div className='px-4 sm:px-6 pb-4 pt-2 border-t border-gray-700'>
