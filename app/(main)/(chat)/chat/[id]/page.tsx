    ...
    <div className='flex h-full relative'>
      ...
      <div className='flex-1 flex flex-col min-w-0'>
        <div className='flex-1 flex flex-col overflow-hidden'>
          ...
          <div className='px-3 sm:px-4 md:px-6 py-3 sm:py-4 border-b border-gray-700 flex-shrink-0'>
            <h2 className='text-white text-lg sm:text-xl md:text-2xl lg:text-[28px] font-bold truncate'>
          ...
          {/* Chat Messages - Mejorado padding móvil */}
          <div className='flex-1 px-3 sm:px-4 md:px-6 py-3 sm:py-4 overflow-y-auto custom-scrollbar'>
            <div className='space-y-4 sm:space-y-6 max-w-4xl mx-auto'>
              {/* Mensaje de bienvenida si no hay mensajes - Avatares más pequeños */}
              {messages.length === 0 && !isSending && (
                <div className='flex items-end gap-2 sm:gap-3'>
                  ...
                  <div className='flex flex-1 flex-col gap-1'>
                    ...
                    <div className='text-sm sm:text-base max-w-[280px] sm:max-w-[400px] lg:max-w-[500px] rounded-lg px-3 py-2 sm:px-4 sm:py-3 bg-slate-700 text-white'>
                      <p>
              ...
              {/* Indicador de que el bot está escribiendo - Mejorado */}
              {isSending && (
                <div className='flex items-end gap-2 sm:gap-3'>
                  <div
                    className='bg-center bg-no-repeat aspect-square bg-cover rounded-full w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 flex-shrink-0'
                  ...
                  <div className='flex flex-1 flex-col gap-1'>
                    <p className='text-slate-400 text-xs sm:text-sm'>TesisAI</p>
                    <div className='text-sm sm:text-base max-w-[200px] rounded-lg px-3 py-2 sm:px-4 sm:py-3 bg-slate-700 text-white'>
          ...
          {/* Chat Input - Bottom of Chat Area - Mejorado padding */}
          <div className='px-3 sm:px-4 md:px-6 pb-3 sm:pb-4 pt-2 border-t border-gray-700 flex-shrink-0'>
