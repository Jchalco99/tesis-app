...
import { Edit, Loader2, LogOut, UserX } from 'lucide-react'
  ...
  return (
    <div className='h-full overflow-y-auto custom-scrollbar'>
      <div className='p-3 md:p-6 space-y-4 md:space-y-6 pb-8'>
        ...
        <InfoSection title='Información del Usuario' items={userInfo} />

        <InfoSection title='Actividad del Usuario' items={userActivity} />
