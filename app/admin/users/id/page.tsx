...
export default function AdminUserPage() {
  ...
  const userActivityTable = [
    { id: 1, date: '2024-07-26', action: 'Consulta', details: 'Tesis sobre energías renovables' },
    { id: 2, date: '2024-07-25', action: 'Consulta', details: 'Pretesis sobre inteligencia artificial' },
